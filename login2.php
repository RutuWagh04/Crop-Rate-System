    ...
    <form action="login2.php" method="POST">
           ...
           <div class="form"> 
            ...
            <div class="inputBox"> 
             ...
             <input type="text" style="width: 300px;" name="username" required> <i>Username</i> 
            ...
            <div>
              <b style="font-color:white;"><b  style="color: #fff;">
                ...
                <a href="register.php">Click Here
                </a></b></b>
...
if(isset($_POST['save']))
{
    ...
    $res=mysqli_query($con,"SELECT * FROM farmer WHERE username='".$username."' && password='".$password."'");
