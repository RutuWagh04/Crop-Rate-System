    ...
    <form action="login3.php" method="POST">
           ...
           <div class="form"> 
            ...
            <div class="inputBox"> 
             ...
             <input type="text" style="width: 300px;" name="uname" required> <i>Username</i> 
...
if(isset($_POST['save']))
{
    ...
    $res=mysqli_query($con,"SELECT * FROM market WHERE musername='".$uname."' && mpassword='".$pass."'");
   ...
   if($num=mysqli_num_rows($res)>0)
     {
     session_start();
     $_SESSION['market']=$row[0];

    echo'
    <script>
        window.location.href="market/index.php";
    </script>
    ';
    }
