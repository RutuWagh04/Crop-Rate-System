            ...
            <!-- last row starts here -->
             <div class="row">
              ...
              <div class="col-md-6 grid-margin stretch-card" style="">
                <div class="card" style="background-color: #ffc299;border-top-left-radius: 30px;border-top-right-radius: 30px;">
                  <div class="card-body">
                    ...
                    <br>
                    <form action="farmer.php" method="POST" class="forms-sample" enctype="multipart/form-data">
                    
                      <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label" style="font-weight:bold;">Farmer Name</label>
                        <div class="col-sm-9">
                          <input name="fname" style="border-left: 2px solid green;border-right: 2px solid green;border-radius: 5px;font-weight: bold;" type="text" class="form-control" id="exampleInputEmail2" />
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label" style="font-weight:bold;">Email</label>
                        <div class="col-sm-9">
                          <input name="mail" style="border-left: 2px solid green;border-right: 2px solid green;border-radius: 5px;font-weight: bold;" type="email" class="form-control" id="exampleInputEmail2" />
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label" style="font-weight:bold;">Contact</label>
                        <div class="col-sm-9">
                          <input name="num" style="border-left: 2px solid green;border-right: 2px solid green;border-radius: 5px;font-weight: bold;" type="text" class="form-control" id="exampleInputEmail2" />
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label" style="font-weight:bold;">Adhar No.</label>
                        <div class="col-sm-9">
                          <input name="adhar" style="border-left: 2px solid green;border-right: 2px solid green;border-radius: 5px;font-weight: bold;" type="text" class="form-control" id="exampleInputEmail2" />
                        </div>
                      </div>

                      <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label" style="font-weight:bold;">Photo</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input name="username" style="border-left: 2px solid green;border-right: 2px solid green;border-radius: 5px;font-weight: bold;" type="text" class="form-control" id="exampleInputEmail2" />
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label" style="font-weight:bold;">Password</label>
                        <div class="col-sm-9">
                          <input name="password" style="border-left: 2px solid green;border-right: 2px solid green;border-radius: 5px;font-weight: bold;" type="text" class="form-control" id="exampleInputEmail2" />
                        </div>
                      </div>
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <img src="image/8.jpg" style="width: 700px;height: 700px;">
              </div>
...
<?php
 ...
 $max=mysqli_fetch_row($max1);
    ...
    if (mysqli_query($con,"INSERT INTO farmer VALUES('','".$fname."','".$email."','".$contact."','".$adhar."','".$targetfile."','".$username."','".$password."')")) 
    {
      echo "
        <script>
