                    ...
                    <div class="table-responsive">
                      <table class="table table-striped" >
                        ...
                        <tbody>
                           ...
                           <?php
                               $res=mysqli_query($con,"SELECT * FROM subcat");
                                while($row=mysqli_fetch_row($res))
                               {
                                $sname=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM category WHERE cid='".$row[1]."'"));
                                  echo '
                              <tr>
                               
                                <td style="height:50px">'.$row[0].'</td>
                                <td style="height:50px">'.$sname[1].'</td>
                                <td style="height:50px">'.$row[2].'</td>
                                    <td>
                                         <center>
                                           <a href="update_subcat.php?sid='.$row[0].'">
                                      ...
                                      <td>
                                         <a href="delete_subcat.php?id='.$row[0].'">
