                           ...
                           <?php
                              ...
                              <tr>
                                ...
                                <td style="height:50px">
                                  <img src="'.$row[5].'" style="height:100px;width:100px">
                                </td>
                                <td style="height:50px">'.$row[1].'</td>
                                <td style="height:50px">'.$row[2].'</td>
                                <td style="height:50px">'.$row[3].'</td>
                                <td style="height:50px">'.$row[4].'</td>
                                <td style="height:50px">'.$row[6].'</td>
                                <td style="height:50px">'.$row[7].'</td>
                                    <td>
                                         <a href="update_farmer.php?cid='.$row[0].'">
                                         <center>
